...
describe('what compact does — and what it deliberately does not', () => {
  ...
  it('keeps EVERY other field, because nothing here knows which MusicBrainz fields matter', () => {
    ...
    const record = {
      id: 'mb1', title: 'Album', 'artist-credit': [], date: '2026-01-01', country: 'US', disambiguation: '',
  ...
  it('keeps a page URL', () => {
    const d = { link: 'https://musicbrainz.org/release/mb1' };
